...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Wigg. O que seu cabelo merece, e seu bolso também.</title>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="editperfil.php" class="nav-item nav-link">Editar Perfil</a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 col-md-6">
                        <div class="hero-text">
                            <h1>Wigg. O que seu cabelo merece, e você também!</h1>
                            <p>
                                O melhor não só para o seu cabelo, como para toda a saúde estética que você merece! 
                                Aqui, você vai descobrir os vários serviços e produtos que só a WIGG te proporciona!
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="section-header text-left">
                            <p>Sobre nós</p>
                            <h2>Desde 2021 no mercado, ajudando você a evitar a burocracia na hora de dar um trato no seu visual.</h2>
                        </div>
        ...
        <div class="service">
            <div class="container">
                <div class="section-header text-center">
                    <p>Confira os </p>
                    <h2>Nossos parceiros com as melhores avaliações</h2>
                </div>
                <div class="row">
        ...
        <div class="team">
            <div class="container">
                <div class="section-header text-center">
                    <p>e também temos</p>
                    <h2>Os melhores barbeiros para você.</h2>
                </div>
                <div class="row">
